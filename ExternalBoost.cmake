...
set(Boost_AS_EXTERNAL_PROJECT False)

if (${Boost_FILESYSTEM_FOUND} AND ${Boost_PROGRAM_OPTIONS_FOUND})
  message("-- *** FOUND Boost filesystem and program_options")
else()
  message("-- *** Boost filesystem and/or program_options not found")
  message("-- *** ADDING BOOST AS AN EXTERNAL PROJECT")
  ...
  ExternalProject_Add(BOOST_EXTERNAL_PROJECT
                      ...
                      set(Boost_AS_EXTERNAL_PROJECT True)
endif()
